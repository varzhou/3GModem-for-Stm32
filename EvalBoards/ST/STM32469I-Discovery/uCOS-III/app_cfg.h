...
#define APP_TASK_START_PRIO                  17u 

#define BSP_SER_TASK_PRIO                     15u
#define SER_SHELL_EXEC_TASK_PRIO             12u
...
#define BSP_SER_TASK_STK_SIZE               256
#define SER_SHELL_EXEC_TASK_STK_SIZE       512u
