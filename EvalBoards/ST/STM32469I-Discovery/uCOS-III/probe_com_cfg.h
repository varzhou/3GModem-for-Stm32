...
#define  PROBE_RS232_CFG_TASK_PRIO                        17    /*  Configure parse task priority   (see Note #2a).     */
#define  PROBE_RS232_CFG_TASK_STK_SIZE                   128    /*  Configure parse task stack size (see Note #2b).     */



#define  PROBE_RS232_UART_3                                1
#define  PROBE_RS232_UART_6                                2
#define  PROBE_RS232_CFG_COMM_SEL         PROBE_RS232_UART_6    /* Configure UART selection (see Note #3).              */
...
#define  PROBE_TCPIP_CFG_SOCK_BLOCK_EN           DEF_DISABLED
#define  PROBE_TCPIP_CFG_SOCK_WAIT_DLY           5

#define  PROBE_TCPIP_CFG_TASK_PRIO                        17    /*  Configure parse task priority   (see Note #2a).     */
#define  PROBE_TCPIP_CFG_TASK_STK_SIZE                   256//512    /*  Configure parse task stack size (see Note #2b).     */
...
#define  PROBE_USB_CFG_TASK_PRIO                          17    /*  (c) Set task priority.                              */
